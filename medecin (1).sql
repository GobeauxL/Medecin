...
(2, 'Fernandes', 'Brice', '3 rue de léglice', '55000', 'Contrisson', '0646783215', 'bri1', 'sio,55(1'),
...
--
ALTER TABLE `patient`
  MODIFY `idPatient` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
--
-- AUTO_INCREMENT pour la table `rdv`
--
ALTER TABLE `rdv`
  MODIFY `idRdv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
--
